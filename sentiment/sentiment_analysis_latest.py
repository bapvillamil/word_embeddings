...
st.markdown("<h1 style='text-align: center; color: red;'>Sentiment Analysis</h1>", unsafe_allow_html=True)
...
if analysis_type == "Single Text Analysis":
    ...
    if upload_file is not None:
        ...
        elif count_positive == count_positive == count_neutral:
            st.write("""# The file is BALANCED between POSTIVE, NEGATIVE, and NEUTRAL Texts """)
        else:
            st.write(""" """)
        
        #elif count_positive == count_negative and upload_file is not None:
            #st.write("""# The file contains EQUAL number of POSITIVE and NEGATIVE Texts""")
        #elif count_positive == count_positive == count_neutral and upload_file is not None:
            #st.write("""# The file is BALANCED between POSTIVE, NEGATIVE, and NEUTRAL Texts """)
        #else:
            #st.write(""" """)
        ...
        #Graph will show if there is file uploaded
